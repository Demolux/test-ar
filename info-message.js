...
AFRAME.registerComponent('info-message', {
  ...
  addStyles: function () {
    var css =
      ...
      'bottom: 5px; left: 5px; color: rgb(51, 51, 51); padding: 20px 15px 0 15px;' +
      'font-size: 11pt; line-height: 20pt; z-index: 9999}' +

      '.a-info-message {color: black;' +
      'position: fixed; text-decoration: none; transition: .05s ease;}' +
      ...
      '.a-info-message-container {position: fixed; left: 83px; bottom: 5px;}' +
